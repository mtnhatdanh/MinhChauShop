            ...
            <div class="login">
                	<div class="registrd">
                        ...
                        <ul class="forms">
                            ...
                            <li class="inputfield"><input type="text" name="s" class="bar" /></li>
                        </ul>
                        <ul class="forms">
                        	<li class="txt">Password <span class="req">*</span></li>
                            <li class="inputfield"><input type="password" name="s" class="bar" /></li>
                        </ul>
                        <ul class="forms">
                        	<li class="txt">&nbsp;</li>
                            <li><a href="#" class="simplebtn"><span>Login</span></a> <a href="#" class="forgot">Forgot Your Password?</a></li>
                        </ul>
                    </div>
                    <div class="newcus">
                    	<h3>Please Sign In</h3>
